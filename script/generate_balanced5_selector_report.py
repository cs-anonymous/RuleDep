...
FEATURE_DEFINITIONS = [
    {
        ...
        "source": "script/analyze_official_query_subsets.py: synergy_values from synergy_filtered.txt weights; topk_stats(..., prefix='synergy_weight').",
    },
    {
        ...
        "source": "script/analyze_official_query_subsets.py: max(dep_scores), where dep_scores collect candidate['dependencyScore'].",
    },
    {
        ...
        "source": "script/analyze_official_query_subsets.py: safe_mean(sorted(rule_values, reverse=True)[:3]), where rule_values collect candidate['maxplus'].",
    },
    {
        "feature": "num_neg_dep",
        ...
        "source": "script/analyze_official_query_subsets.py: len(redundancy_values).",
    },
    {
        ...
        "source": "script/analyze_official_query_subsets.py: exp(-sum p log p) from stage1_scores.",
    },
]
